-- ============================================================================
-- Transactional Outbox for Booking Service
-- ============================================================================
-- Used for reliable event publishing to Kafka/Redpanda
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS outbox (
    ...
    aggregate_id UUID NOT NULL,           -- ID of the related booking
    event_type VARCHAR(100) NOT NULL,     -- e.g., 'booking.created', 'booking.confirmed'
